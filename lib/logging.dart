...
abstract class Logger {
  ...
  void warning(String message, [dynamic error]) => log(LogLevel.warning, message, error);
...
class RSocketLogger {
  ...
  static void warning(String message, [dynamic error]) => _instance.warning(message, error);
